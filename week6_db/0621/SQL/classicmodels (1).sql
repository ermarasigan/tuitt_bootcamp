...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2017 at 02:15 AM
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmployeeNumber`) REFERENCES `employees` (`employeeNumber`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `employees`
  ...
  ADD CONSTRAINT `employees_ibfk_2` FOREIGN KEY (`reportsTo`) REFERENCES `employees` (`employeeNumber`) ON DELETE SET NULL ON UPDATE CASCADE;
